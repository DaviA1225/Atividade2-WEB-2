...
try{
    $sql = "SELECT * FROM professor (nome,idade,cpf,sexo) VALUES ('".$professor->getNome()."','".$professor->getIdade()."','".$professor->getCPF()."','".$professor->getSexo()."' WHERE siape='".$professor->getSiape()."')";
