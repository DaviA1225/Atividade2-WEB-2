...
try{
    ...
    $sql = "DELETE FROM professor SET nome = '" . $professor->getNome() . "', idade = '" . $professor->getIdade() . "', cpf = '" . $professor->getCpf() . "' , sexo = '" . $professor->getSexo() . "' WHERE siape= '". $professor->getSiape()."'";
